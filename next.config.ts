...
const securityHeaders=[
  {key:'Content-Security-Policy',value:"default-src 'self'; img-src 'self' https: data:; media-src 'self' https: data:; connect-src 'self' http://127.0.0.1:8000 http://localhost:8000 https://efootball-tournament-kwq4.onrender.com https://image.pollinations.ai; style-src 'self' 'unsafe-inline'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; frame-ancestors 'none'; base-uri 'self'; form-action 'self'"},
